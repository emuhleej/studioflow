...
describe('MediaPreview', () => {
  it('shows loading and then renders private media', async () => {
    vi.mocked(createMediaAccess).mockResolvedValue({
      url: 'https://private.example/preview',
      release: vi.fn(),
    });
    ...
    expect(await screen.findByLabelText(remoteAsset.filename)).toHaveAttribute(
      'src',
      'https://private.example/preview'
    );
  });
